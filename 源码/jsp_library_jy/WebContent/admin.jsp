    ...
    <script type="text/javascript">
        $(function () {
            $("#book_manage").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/book/book-list.jsp");
            });
            $("#book_add").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/book/book.do?method=preAdd");
            });
            $("#reader_add").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/reader/reader-add.jsp");
            });
            $("#reader_manage").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/reader/reader-list.jsp");
            });
            $("#borrow_manage").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/borrow-manage.jsp");
            });
            $("#book_count").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/data-book.jsp");
            });
            $("#book_count2").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/data-book-pie.jsp");
            });
            $("#borrow_back").click(function(){
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/return-manage.jsp");
            });
            $("#book-class-manage").click(function () {
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/bookcase-list.jsp");
            });
            $("#book-class-add").click(function () {
                $("iframe").attr("src","<%=request.getContextPath()%>/admin/bookcase-add.jsp");
            });
        })
    </script>
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item"><a href="<%=request.getContextPath()%>/account.do?method=logout">退出</a></li>
        </ul>
    </div>
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a id="book_export" href="<%=request.getContextPath()%>/admin/bookAdmin.do?method=exportDataInfo&type=book">导出图书数据</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-body">
        ...
        <iframe src="<%=request.getContextPath()%>/book/book-list.jsp" style="width: 100%;height: 100%;border: 0px"></iframe>
