...
<head>
    ...
    <style>
        body {
            background: url("<%=request.getContextPath()%>/images/bg-2.jpg") no-repeat;
...
<body>
    <div class="layui-container-form-box" style="width: 500px;background-color: #cccccc">
        ...
        <form action="<%=request.getContextPath()%>/book/book.do?method=edit" method="post" class="layui-form" style="margin-left: 20px">
