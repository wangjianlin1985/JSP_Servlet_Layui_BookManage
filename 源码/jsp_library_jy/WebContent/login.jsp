...
<div id="tab">
    ...
    <div class="tab_box">
        ...
        <div>
            ...
            <form action="<%=request.getContextPath()%>/account.do?method=login&type=reader" class="reader_login_error" method="post">
                <div id="username">
                    <label>用户名：</label>
                ...
                <div id="code">
                    <label>验证码：</label>
                    <input type="text" id="reader_code_hide" name="code" value="输入验证码" nullmsg="验证码不能为空！"
        ...
        <div class="hide">
            ...
            <form action="<%=request.getContextPath()%>/account.do?method=login&type=bookadmin" class="admin_login_error" method="post">
                <div id="username">
                    <label>用户名：</label>
                ...
                <div id="code">
                    <label>验证码：</label>
                    <input type="text" id="admin_code_hide" name="code" value="输入验证码" nullmsg="验证码不能为空！"
                           datatype="*4-4" errormsg="验证码有4位数！" readermsg="验证码验证通过！"/>
                    <img src="images/captcha.jpg" title="点击更换" alt="验证码占位图"/>
                </div>
                <div id="remember">
