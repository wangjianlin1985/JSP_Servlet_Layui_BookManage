...
<head>
    ...
    <style>
        body {
            background: url("<%=request.getContextPath()%>/images/bg-3.jpg") no-repeat;
...
<div class="layui-container-form-box" style="width: 500px;background-color: #cccccc">
    ...
    <form action="<%=request.getContextPath()%>/reader/reader.do?method=edit" method="post" class="layui-form" style="margin-left: 20px">
