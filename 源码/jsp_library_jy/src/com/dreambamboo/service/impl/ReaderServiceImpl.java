...
import com.dreambamboo.repository.ReaderRepository;
import com.dreambamboo.repository.impl.ReaderRepositoryImpl;
import com.dreambamboo.service.ReaderService;
import com.dreambamboo.vo.BorrowDTO;
...
public class ReaderServiceImpl implements ReaderService {
    ...
    public Borrow findBorrowByIds(int bookId, int readerId, int state) {
        return this.readerRepository.selectBorrowByIds(bookId,readerId,state);
    }
